...
// For partitioned sovereign projects (e.g. "eu0:kcc-eval-de" or "fr0:project-id"),
// colons are illegal in email domains (RFC 5322), so IAM reverses the partition prefix into a subdomain:
// "<sa-name>@<project-name>.<partition>.iam.gserviceaccount.com" (e.g. "kcc-test-sa@kcc-eval-de.eu0.iam.gserviceaccount.com").
...
// For partitioned projects (e.g. "eu0:kcc-eval-de"), it produces "<project-name>.<partition>.svc.id.goog".
