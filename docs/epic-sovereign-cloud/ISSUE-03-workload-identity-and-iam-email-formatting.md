...
In Sovereign Cloud and multi-partition Google Cloud environments, project IDs include partition qualifiers separated by colons (e.g., `eu0:kcc-eval-de` in Sovereign Germany, or `fr0:project-id` in Sovereign France). 
...
```
kcc-test-sa@eu0:kcc-eval-de.iam.gserviceaccount.com
```
...
- [ ] Partitioned project IDs (e.g., `eu0:kcc-eval-de`) yield valid RFC 5322 emails (`kcc-test-sa@kcc-eval-de.eu0.iam.gserviceaccount.com`).
